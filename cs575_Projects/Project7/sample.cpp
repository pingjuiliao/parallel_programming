...
const char *CL_FILE_NAME = { "ChiWen.cl" };
...
const char *WINDOWTITLE = { "OpenGL / GLUT Sample -- Chi Wen" };
...
Display()
{
	...
	glLoadIdentity();
	gluLookAt(100., 1500., 600., 0., -100., 0., 0., 1., 0.);
